          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">0346427JQK</p>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="#"
                  className="w-10 h-10 bg-blue-800 hover:bg-blue-900 text-white rounded-lg flex items-center justify-center transition-colors duration-300"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
